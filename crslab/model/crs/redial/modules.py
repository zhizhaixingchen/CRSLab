...
class HRNN(nn.Module):
    ...
    def get_utterance_encoding(self, context, utterance_lengths):
        ...
        packed_utterances = pack_padded_sequence(embedded, sorted_lengths.to("cpu"), batch_first=True)
    ...
    def forward(self, context, utterance_lengths, dialog_lengths):
        ...
        packed_sequences = pack_padded_sequence(sorted_representations, sorted_lengths.to("cpu"), batch_first=True)
...
class SwitchingDecoder(nn.Module):
    ...
    def forward(self, request, request_lengths, context_state):
        ...
        packed_request = pack_padded_sequence(embedded_request, sorted_lengths.to("cpu"), batch_first=True)
